...
async function getWordFromAI() {
    try {
        const chatCompletion = await groq.chat.completions.create({
            messages: [{ role: "user", content: "Imaginate que estamos jugando al juego Wordle. ¿Me podrías dar una palabra de 5 letras? Respondeme solo con la palabra de 5 letras en español" }],
